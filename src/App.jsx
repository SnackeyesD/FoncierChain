    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        >
          ...
          <span className="text-xl font-bold tracking-tight">Foncier<span className="text-primary">Chain</span></span>
        </motion.div>
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
        <motion.div
          ...
          className="space-y-8"
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border-primary/20 text-primary text-sm font-medium">
          ...
          >
            Mettons fin aux litiges fonciers. Une parcelle, un propriétaire, pour toujours.
            La transparence blockchain au service des ODD 1, 11 et 16.
          </motion.p>
          ...
          <motion.div variants={fadeInUp} className="pt-12 flex justify-center gap-12 text-slate-500 text-sm">
      ...
      >
        <div className="w-6 h-10 rounded-full border-2 border-slate-600 flex justify-center p-1">
          <motion.div className="w-1 h-2 bg-primary rounded-full" animate={{ y: [0, 12, 0] }} transition={{ duration: 1.5, repeat: Infinity }} />
        </div>
      </motion.div>
    </section>
  );
...
const CrisisSection = () => {
  return (
    <section id="probleme" className="relative py-32 bg-slate-950 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-alert/5 via-slate-950 to-slate-950" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold leading-tight">
              Plus de <span className="text-alert">60%</span> des terrains urbains à Brazzaville sont contestés
            </h2>
            
            <p className="text-slate-400 text-lg leading-relaxed">
              Un même terrain vendu 3 à 5 fois à différents propriétaires. 
              45% des affaires civiles congolaises sont des litiges fonciers. 
              3 à 7 ans pour résoudre un conflit, coût moyen de 500 000 à 3 000 000 FCFA.
            </p>
            
            <div className="grid grid-cols-2 gap-6 pt-4">
              {[
                { label: "Litiges civils", value: "45",suffix: "%", desc: "Affaires foncières" },
                { label: "Durée moyenne", value: "5", suffix: " ans", desc: "Résolution d'un litige" },
                { label: "Coût moyen", value: "1.75", suffix: "M FCFA", desc: "Par ménage" },
                { label: "Propriétaires", value: "3-5x", desc: "Mêmes terrains" }
              ].map((stat, idx) => (
                <motion.div 
                  key={idx}
          ...
          >
            ...
            <div className="relative glass rounded-3xl p-8 border-alert/20">
              <div className="text-center mb-8">
                ...
                <p className="text-slate-400 uppercase tracking-widest text-sm">Taux de contestation</p>
              </div>
...
const SolutionSection = () => {
  ...
  return (
    <section id="solution" className="relative py-32 bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 text-lg">
            FoncierChain élimine la corruption et les erreurs humaines du registre foncier.
            Chaque transaction est traçable, vérifiable et permanente.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              <h3 className="text-3xl font-bold mb-4">Pourquoi la Blockchain ?</h3>
              <p className="text-slate-400 mb-6 leading-relaxed">
                L'immuabilité garantit qu'une parcelle, une fois enregistrée, ne peut pas être 
                ré-enregistrée. Le contrat intelligent rejette automatiquement toute tentative 
                d'enregistrement d'une parcelle déjà présente dans le registre.
              </p>
              ...
              <div className="relative glass rounded-2xl p-6 border border-primary/30">
                ...
                <div className="space-y-3 font-mono text-xs">
                  <div className="p-3 rounded bg-slate-900/50 border border-slate-800">
                    <span className="text-primary">{'>'}</span> Transaction: 0x7f8a9b...
                  </div>
                  <div className="p-3 rounded bg-slate-900/50 border border-slate-800">
                    <span className="text-accent">{'>'}</span> Parcelle: BZV-2024-08912
                  </div>
                  <div className="p-3 rounded bg-red-950/30 border border-red-900/50 text-red-400">
                    <span className="text-alert">✕</span> Double attribution détectée
                  </div>
                  <div className="p-3 rounded bg-green-950/30 border border-green-900/50 text-green-400">
                    <span className="text-primary">✓</span> Rejet automatique - Parcelle existante
                  </div>
                </div>
              </div>
            </div>
...
const CTASection = () => {
  return (
    <section id="impact" className="relative py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-primary/20 via-slate-950 to-slate-950" />
      ...
      >
        ...
        <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto">
          Rejoignez la révolution blockchain pour un Congo où la propriété foncière 
          est sécurisée, transparente et accessible à tous.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <motion.button 
            className="px-10 py-5 rounded-full bg-primary text-slate-950 font-bold text-lg glow-button w-full sm:w-auto"
            whileHover={{ scale: 1.05, boxShadow: "0 0 60px rgba(34, 197, 94, 0.6)" }}
            whileTap={{ scale: 0.95 }}
          >
...
function App() {
  return (
    <div className="bg-slate-950 min-h-screen selection:bg-primary/30">
      <Navigation />
      <Hero />
      <CrisisSection />
      <SolutionSection />
